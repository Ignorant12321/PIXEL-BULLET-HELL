(function (PSD) {
  ...
  PSD.input.create = function createInput(canvas) {
    ...
    // Optional on-screen controls for touch devices. They mirror keyboard actions,
    // so the game loop does not need a separate mobile input path.
    ...
    // Clear any unconsumed presses at frame end to avoid stale inputs
    function endFrame() {
